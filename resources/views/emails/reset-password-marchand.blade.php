...
<div style="text-align: center; margin: 30px 0; padding: 20px; background-color: #fff9f0; border-radius: 8px; border-left: 4px solid #ff8c00;">
    ...
    <div style="font-size: 25px; color: #666; margin-bottom: 10px;">
        {{ $token }}
    </div>
    <div style="font-size: 16px; color: #666; margin-bottom: 10px;">
       Ce code est valable pendant <div style="font-weight: bold; color: #666; margin-bottom: 10px;">15 minutes</div>
    </div>
</div>

⚠️ **Si vous n’êtes pas à l’origine de cette demande**, veuillez ignorer cet email.  
Aucune modification ne sera effectuée sans ce code.
